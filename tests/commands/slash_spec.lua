...
describe("slash commands", function()
    it("has all expected commands registered", function()
        ...
        assert.is_function(slash.commands.debug)
        assert.is_function(slash.commands.explain)
        assert.is_function(slash.commands.fix)
        assert.is_function(slash.commands.test)
        assert.is_function(slash.commands.review)
    end)
